...
This is a copy of lambdananas with some unfinished changes.
I was trying to switch the custom parsing library we used to the one GHC was using.
This would have allowed tighter control over language extensions and other constructs.
